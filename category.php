<?php 
    ...
    $post_sql2 = "SELECT * FROM category WHERE category_id ={$current_id}";
    $post_query2 = mysqli_query($conn, $post_sql2) or die("Query unsuccessful");

    $cat_name = mysqli_fetch_assoc($post_query2);
?>
    <div id="main-content">
      <div class="container">
        <div class="row">
                ...
                if(isset($_GET['cid'])){
                  ...
                  $post_query = mysqli_query($conn, $post_sql) or die("Query unsuccessful");
                    ...
                    if(mysqli_num_rows($post_query2)>0){
                        ...
                        if($page>1){
                            echo "<li><a href='index.php?cid=".$current_id."&page=".($page-1)."'>Prev</a></li>";
                        }
                        for($i=1; $i<=$total_page; $i++){
                            ...
                            echo "<li class='{$active}'><a href='index.php?cid=".$current_id."&page={$i}'>{$i}</a></li>";
                        }    
                        if($total_page > $page){
                            echo "<li><a href='index.php?cid=".$current_id."&page=".($page+1)."'>Next</a></li>";
                        }
                        echo "</ul>";
                    }
                }
